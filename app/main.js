  ...
  arrayProjetos.forEach(projeto => {
    localNaPagina.innerHTML += `
      <div class="projetos__item">
        ...
        <a href="${projeto.clone_url}" class="veja-codigo"><img src="./assets/contatos/github_logo_icon.svg" alt="">Veja o código</a>
        <a href="${projeto.homepage}" class="veja-projeto"><img src="./assets/ferramentas/logo_vercel_icon.svg" alt="">Veja o projeto</a>
      </div>
    `
  })
}
